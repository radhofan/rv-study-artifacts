...
public class JUnitExtension extends AbstractEventSpy {
    ...
    private static final String DEPENDENCY_ARTIFACT_ID = "junit-measure-time";
    private static final String DEPENDENCY_VERSION = "1.0";
    private static final String DEPENDENCY_PROPERTY_VALUE = "edu.rvpaper.JUnitMeasureTimeListener";
    ...
    public void onEvent(Object event) {
        if (System.getenv("JUNIT_MEASURE_TIME_LISTENER") == null ||
                !System.getenv("JUNIT_MEASURE_TIME_LISTENER").equals("1")) {
            return;
        }
